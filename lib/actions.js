...
// Defaults
var DEFAULT_ACTIONS = ['test', 'list', 'use', 'text', 'variable'];
 ...
 * @param  {Object} deps - Dependencies that are needed in each plugin.
 * 
 * @returns {Object} manifest
 */
exports.createManifest = function (plugins, prefix, deps) {
